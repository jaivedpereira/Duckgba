...
public class Gameboy implements Runnable, Serializable, Originator<Gameboy>, Closeable {
    ...
    private transient Object console;
    ...
    public void init(EventBus eventBus, SerialEndpoint serialEndpoint, Object console) {
        // The optional debug console module from the upstream coffee-gb project is
        // intentionally not bundled in the Android build. The parameter is kept
        // for source compatibility and is simply ignored.
        this.console = null;
    ...
    public void init(EventBus eventBus, SerialEndpoint serialEndpoint) {
        init(eventBus, serialEndpoint, null);
    }
    ...
    public boolean tick() {
        ...
        // Debug console hook from upstream coffee-gb is omitted on Android.
        return result;
    }
